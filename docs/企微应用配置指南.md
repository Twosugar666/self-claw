...
2. 确认填的是 XiaoWe **运行所在机器**的 IP，不是你自己电脑的 IP
...
部署完成后，你可以直接在**微信聊天界面**中使用 XiaoWe，无需安装企业微信客户端。
...
2. 点击进入团队 → 找到 **XiaoWe**（或你设置的应用名称）
3. 点击进入聊天页面，就可以开始对话了

![微信中使用XiaoWe的三步流程](images/企业微信截图_17730531067300.png)

> 💡 **小技巧**：长按 XiaoWe 的聊天 → 「置顶聊天」，这样它会一直在微信聊天列表最上方，随时可以发消息记录。
